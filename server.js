...
app.post('/create-checkout-session/:product', async (req, res) => {
    ...
    if (product === 'sub') {
        price_ID = 'price_1MowbJIWzreUJ903PoV7NqL1'
        mode = 'subscription'
        line_items = [
            {
                price: price_ID
        ...
        price_ID = 'price_1MowXdIWzreUJ903BzMfxq7S'
        mode = 'payment'
        line_items = [
            {
                price: price_ID,
    ...
    //use webhook to access the firebase entry for the api key and ensure that billing info is updated accordingly
